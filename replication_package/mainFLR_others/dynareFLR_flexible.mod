...
@#if OptionIRFAndreasen > 0
save("../Output/IRFs/IRFs_FLR_flexible", 'vEMAS', 'vNames', 'mIRFProp_zUncertainty_EMAS', 'mIRFProp_RUncertainty_EMAS', 'vNames_Andreasen', 'mIRFProp_Andreasen_R_EMAS' 'mIRFProp_Andreasen_RVol_EMAS', 'mIRFProp_Andreasen_zVol_EMAS')
@#else
save("../Output/IRFs/IRFs_FLR_flexible", 'vEMAS', 'vNames', 'mIRFProp_zUncertainty_EMAS', 'mIRFProp_RUncertainty_EMAS') 
@#endif 
